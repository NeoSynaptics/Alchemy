...
## Task 5: APU Debug Logger & Event Stream
...
## Task 6: APU Concurrency Fix — Atomic Decide-Evict-Load
...
## Task 7: APU Test Harness — Concurrency, Failures, and Invariants
...
## Task 8: Wire APU health_check + periodic reconciliation into server
